...
module.exports.run = function ({ event, args, api, getText }) {
  ...
  var msg = `𝐍𝐚̆𝐦 𝐧𝐚𝐲 𝐛𝐚̣𝐧 ${tuoi} 𝐭𝐮𝐨̂̉𝐢`
    if (monthout > monthin) {var aftermonth = monthout - monthin; var msg = `𝐍𝐚̆𝐦 𝐧𝐚𝐲 𝐛𝐚̣𝐧 ${tuoi}  𝐭𝐮𝐨̂̉𝐢. 𝐂𝐨̀𝐧  ${aftermonth} 𝐭𝐡𝐚́𝐧𝐠 𝐧𝐮̛̃𝐚 𝐥𝐚̀ 𝐛𝐚̣𝐧 𝐬𝐞̃ 𝐭𝐫𝐨̀𝐧 ${tuoi + 1}  𝐭𝐮𝐨̂̉𝐢`};
  if (monthin == monthout && dayin < dayout) {var afterday = dayout - dayin; var msg = ` 𝐍𝐚̆𝐦 𝐧𝐚𝐲 𝐛𝐚̣𝐧 ${tuoi} 𝐭𝐮𝐨̂̉𝐢. 𝐂𝐨̀𝐧 ${afterday} 𝐧𝐠𝐚̀𝐲 𝐧𝐮̛̃𝐚 𝐥𝐚̀ 𝐛𝐚̣𝐧 𝐬𝐞̃ 𝐭𝐫𝐨̀𝐧 ${tuoi + 1} 𝐭𝐮𝐨̂̉𝐢`};
