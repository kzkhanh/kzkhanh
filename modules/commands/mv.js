...
`,attachment: fs.createReadStream(__dirname + `/cache/mv.gif`)}, event.threadID, event.messageID);
  ...
  if (money >= 100) {
  axios.get('https://kz-api.kzbott.repl.co/getLink2').then(res => {
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://randomapi--kzbott.repl.co/images/videogaixinh').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://randomapi--kzbott.repl.co/images/vdsex').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
            body: `🎊 𝗩𝗶𝗱𝗲𝗼 𝘀𝗲𝘅 𝗻𝗲̀\n -1000 đô💸`,
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://kz-api.kzbott.repl.co/vdtraiv2').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
            body: `🌺 𝗩𝗶𝗱𝗲𝗼 𝗧𝗿𝗮𝗶 𝗻𝗲̀\n -1000 đô💸`,
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://kz-api.kzbott.repl.co/vdanime').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://kz-api.kzbott.repl.co/vdaodaiv2').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://kz-api.kzbott.repl.co/chill').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('API BẦU TRỜITRỜI').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://kz-api.kzbott.repl.co/doraemon').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
