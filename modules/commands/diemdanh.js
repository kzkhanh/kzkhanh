...
description: "Điểm danh nhận quà hằng ngày\n diemdanh info => xem thông tin phần quà\n diemdanh 7day => nhận quà bí mật khi tích đủ 7 điểm nhận từ đăng nhập hàng ngày",
...
fs.writeFileSync(path, JSON.stringify(dataDaily));
     return api.sendMessage(
       `Đã thêm bạn vào cơ sở dữ liệu vui lòng dùng lại lệnh để nhận thưởng!`,
       threadID);
  }
...
return api.sendMessage({
 ...
 + "dùng " + global.config.PREFIX +"daily 7 day " + "để nhận quà\n"
 + "   ◆━━━━━•💜•━━━━━◆\n\n"
