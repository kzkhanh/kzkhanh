...
module.exports.config = {
    ...
    version: "1.0.1",
    hasPermssion: 0,
    credits: "", //Sang Nguyễn edit mod, Code working của diện,suhao chỉnh chữ thoai ko có rì đâu
    description: "💴𝐁𝐨̂́𝐜 𝐓𝐡𝐚̆𝐦 𝐯𝐨̛́𝐢 𝐜����́c 𝐠𝐨́𝐢 𝟏𝟎𝐤 𝟐𝟎𝐤 𝟓𝟎𝐤 𝟏𝟎𝟎𝐤 𝟐𝟎𝟎𝐤 𝟓𝟎𝟎𝐤💎",
    commandCategory: "May Mắn",
    cooldowns: 5,
    envConfig: {
        cooldownTime: 0 
    },
...
var f = Math.floor(Math.random() * 100) + 50;
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            var t = Date.parse("January 22, 2023 00:00:00") - Date.parse(new Date()),
...
module.exports.run = async ({  
    ...
    let data = (await Currencies.getData(senderID)).data || {};
    var   t = Date.parse("January 22, 2023") - Date.parse(new Date()),
    d = Math.floor( t/(1000*60*60*24) ),
    h = Math.floor( (t/(1000*60*60)) % 24 ),
    m = Math.floor( (t/1000/60) % 60 );
