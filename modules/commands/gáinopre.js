...
moment.tz('Asia/Ho_Chi_Minh').format('dddd');
  ...
  if (typeof thread["gái","girl"] !== "undefined" && thread["chill"] == false) return;
...
module.exports.languages = {
  "vi": {
    "on": "Bật",
    "off": "Tắt",
    "successText": "gái thành công",
  },
  "en": {
    "on": "on",
    "off": "off",
    "successText": "gái success!",
  }
}
...
module.exports.run = async function({
  ...
  if (typeof data["gái","girl"] == "undefined" || data["gái","girl"] == true) data["gái","girl"] = false;
  else data["gái","girl"] = true;

  await Threads.setData(threadID, {
    data
  });
  global.data.threadData.set(threadID, data);
  return api.sendMessage(`${(data["gái","girl"] == false) ? getText("off") : getText("on")} ${getText("successText")}`, threadID, messageID);
}