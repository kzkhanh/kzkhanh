...
let {messageID, threadID, senderID} = event;
  ...
  */
  ...
  var dtwbox = bans.warns[threadID];
      ...
      allwarn == "" ? api.sendMessage({body: "Nhóm bạn chưa có ai bị ban.",attachment: (await axios.get((await axios.get(`https://sex.accountkz.repl.co/phongcanhv2`)).data.url, {
                    responseType: 'stream'
                })).data}, threadID, messageID) : api.sendMessage( "Danh sách những thành viên đã bị cấm vào nhóm:\n\n"+allwarn, threadID, messageID);
}